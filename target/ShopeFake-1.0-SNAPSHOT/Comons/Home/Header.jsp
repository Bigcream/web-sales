        ...
        <div class="container"> 
            ...
            <nav class="navbar ownmenu">
                ...
                <div class="collapse navbar-collapse" id="nav-open-btn">
                    <ul class="nav">
                        <li class="dropdown active"> <a href="<c:url value='/HomeWeb'/>" >Home</a>
                        </li>
                        ...
                        <c:if test="${not empty USERMODEL }">
                            ...
                            <li class="dropdown user-acc"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" ><i class="icon-user"></i> </a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <h6>HELLO! ${USERMODEL.fullName}</h6>
                                    </li>
                                    <li><a href="<c:url value='/Cart'/>">MY CART</a></li>
                                    <li><a href="<c:url value='/Info'/>">ORDER INFO</a></li>
                                    <li><a href="<c:url value='/HomeWeb?action=logout'/>">LOG OUT</a></li>
                                </ul>
                            </li>
                        </c:if>
                        <c:if test="${empty USERMODEL }">
                            <a class="nav-link" href='<c:url value="//Login?action=login"/>'>Log in</a>
                        </c:if>
                        <!-- USER BASKET -->
                        <li class="dropdown user-basket"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><i class="icon-basket-loaded"></i> </a>
                            <ul class="dropdown-menu">
                                <c:forEach var="item" items="${cart.items}">
                                    <li>
                                        <div class="media-left">
                                            <div class="cart-img"> <a href="#"> <img class="media-object img-responsive" src="${item.productModel.image_Link}" alt="..."> </a> </div>
                                        </div>
                                        <div class="media-body">
                                            <h6 class="media-heading">${item.productModel.name}</h6>
                                            <span class="price">${item.productModel.price}$</span> <span class="qty">QTY: ${item.quantity}</span> </div>
                                    </li>
                                </c:forEach>
                                <li>
                                    <h5 class="text-center">TOTAL MONEY: ${cart.totalMoney}$</h5>
                                </li>
                                <li class="margin-0">
                                    <div class="row">
                                        <div class="col-xs-6"> <a href="<c:url value='/Cart'/>" class="btn">VIEW CART</a></div>
                                        <div class="col-xs-6 "> <a href="<c:url value='/CheckOut'/>" class="btn">CHECK OUT</a></div>
                                    </div>
                                </li>
                            </ul>
                        </li>
