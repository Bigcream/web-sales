                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            <c:if test="${not empty messageLogin}">
                                                <div class="alert alert-${alertLogin}">
                                                    ${messageLogin}
                                                </div>
                                            </c:if>
                                        ...
                                        <div class="toolbar clearfix">
                                            ...
                                            <div>
                                                <a href="#" id="iWantRegister" data-target="#signup-box" class="user-signup-link">
                                                    I want to register
...
<![endif]-->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $("#btn-login-dark").click();
            });


            document.getElementById("#btn-login-dark").click();
        </script>
        <script>
            $(document).ready(function () {
                $("#iWantRegister").click();
            ...
            document.getElementById("#iWantRegister").click();
            var iWantRegister = ${iWantRegister};
            if (iWantRegister != null) {
                $(document).ready(function () {
                    $("#iWantRegister").click();
                });
            }
